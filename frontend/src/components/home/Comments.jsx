...
const Comments = () => {
  ...
  const { loader, comment_message, comment } = useSelector(
  ...
  return (
    <>
      <div className="comments">
        ...
        {comment.length > 0
          ? comment.map((c, index) => (
              <div key={c._id} className="main-reply-comment">
                <div className="image-comment-time-name">
                  ...
                  <div className="name-time-comment">
                    ...
                    <div className="replay_btn">
                      {userInfo && (
                        <button onClick={() => setReply(c._id)}>Reply</button>
                      )}
                    </div>
                    <div
                      className={
                        show_reply === c._id ? "reply_box show" : "reply_box"
                      }
                    >
                      ...
                      <div className="reply_submit">
                        <button onClick={() => setReply("")} className="cancle">
                          Cancel
                        </button>
                        <button
                    ...
                    {c.replyComment.length > 0 &&
                      c.replyComment.map((rc, index) => (
                        <div key={rc._id} className="reply_comment">
                          <div className="reply_comment_image_name_time">
                            ...
                            <div className="name-time-comment">
                              ...
                              <div className="replay_btn">
                                {userInfo && (
                                  <button onClick={() => setReply(rc._id)}>
                                    Reply
                                  </button>
                                )}
                              </div>
                          ...
                          {(userInfo.role === "admin" ||
                            (userInfo.role === "sub admin" &&
                              userInfo.id === read_article.adminId)) && (
                            <div
                              className="action"
                              onClick={() =>
                                dispatch(
