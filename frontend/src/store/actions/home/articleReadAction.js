...
export const get_article_details = (articleSlug) => async (dispath) => {
  try {
    const response = await axios.get(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/home/article-details/${articleSlug}`,
...
export const like_dislike_get = (articleSlug) => async (dispath) => {
  try {
    const response = await axios.get(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/home/like-dislike-get/${articleSlug}`,
      { withCredentials: true }
    );
    dispath({
...
export const user_article_like = (data) => async (dispatch) => {
  try {
    const response = await axios.put(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/user-like-article`,
      data,
      { withCredentials: true }
    );
    dispatch({
...
export const user_article_dislike = (data) => async (dispatch) => {
  try {
    const response = await axios.put(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/user-dislike-article`,
      data,
      { withCredentials: true }
    );
    dispatch({
