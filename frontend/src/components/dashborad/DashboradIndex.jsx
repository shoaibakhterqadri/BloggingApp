    ...
    <div className="dashborad-main-content-elements">
      <div className="dashborad-elements">
        <div className="cards">
          ...
          <Link className="single-card" to="/dashborad/all-article">
            <div className="card_icon">
              <BsFillPeopleFill />
            </div>
            <div className="card_info">
              <h2>
                {articleCount > 1 ? `${articleCount - 1}+` : articleCount}
              </h2>
              <span>Articles</span>
            </div>
          </Link>
          <Link className="single-card" to="/dashborad/all-category">
            <div className="card_icon">
              <FaRegCaretSquareRight />
            </div>
            <div className="card_info">
              <h2>
                {categoryCount > 1 ? `${categoryCount - 1}+` : categoryCount}
              </h2>
              <span>Categorys</span>
            </div>
          </Link>
          <Link className="single-card" to="/dashborad/all-tag">
            <div className="card_icon">
              <FaTag />
            </div>
            <div className="card_info">
