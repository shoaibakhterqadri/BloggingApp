...
export const get_tag_category = () => async (dispatch) => {
  try {
    const response = await axios.get(
      "https://ill-tan-tuna-sock.cyclic.app/rest-api/get-tag-category",
...
export const add_articale = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://ill-tan-tuna-sock.cyclic.app/rest-api/add-artical",
      data,
      { withCredentials: true }
    );
    dispatch({
...
export const get_all_article =
  (currentPage, searchValue) => async (dispatch) => {
    try {
      const response = await axios.get(
        `https://ill-tan-tuna-sock.cyclic.app/rest-api/get-artical?currentPage=${currentPage}&&searchValue=${searchValue}`,
        { withCredentials: true }
      );
      dispatch({
...
export const article_edit = (articleSlug) => async (dispatch) => {
  try {
    const response = await axios.get(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/edit-artical/${articleSlug}`,
      { withCredentials: true }
    );
...
export const article_update = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://ill-tan-tuna-sock.cyclic.app/rest-api/update-artical",
      data,
      { withCredentials: true }
    );
    dispatch({
...
export const delete_article = (articleId) => async (dispatch) => {
  try {
    const response = await axios.delete(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/delete-artical/${articleId}`,
      { withCredentials: true }
    );
    dispatch({
...
export const update_article_status =
  (articleId, newStatus) => async (dispatch) => {
    try {
      const response = await axios.patch(
        `https://ill-tan-tuna-sock.cyclic.app/rest-api/update-article-status/${articleId}`,
        { status: newStatus },
        { withCredentials: true }
      );
