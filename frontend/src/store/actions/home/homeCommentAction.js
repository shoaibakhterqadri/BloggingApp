...
export const user_comment = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://ill-tan-tuna-sock.cyclic.app/rest-api/home/user-comment",
      data,
...
export const get_comment = (articleId) => async (dispatch) => {
  try {
    const response = await axios.get(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/get-home-comment/${articleId}`
    );
    dispatch({
...
export const reply_comment = (data) => async (dispatch) => {
  try {
    const response = await axios.post(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/comment-reply`,
      data,
      { withCredentials: true }
    );
    dispatch({
...
export const comment_delete = (data) => async (dispatch) => {
  try {
    const response = await axios.post(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/comment-home-delete`,
      data,
      { withCredentials: true }
    );
    dispatch({
...
export const comment_reply_delete = (data) => async (dispatch) => {
  try {
    const response = await axios.post(
      `https://ill-tan-tuna-sock.cyclic.app/rest-api/comment-reply-home-delete`,
      data,
      { withCredentials: true }
    );
    dispatch({
